...
public class ExecScriptTest 
{
    ...
    @Test
    public void doTest() throws ProtocolException, IOException, MessageOutputConfigurationException, Exception
    {
        String DF_SCRIPT = "DF_SCRIPT";
        String DF_DISPLAY_SCRIPT_OUTPUT = "DF_DISPLAY_SCRIPT_OUTPUT";
        
        Map<String, Object> map = new HashMap<>();
        map.put("DF_SCRIPT", "echo ${myField}");
